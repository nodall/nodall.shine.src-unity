...
namespace WanzyeeStudio.Json{
	...
	/// <summary>
	/// <c>Newtonsoft.Json.JsonConverter</c> for <c>UnityEngine.Rect</c>.
	/// </summary>
	public class RectConverter : JsonConverter{
		...
		/// <summary>
		/// Determine if the type is <c>UnityEngine.Rect</c>.
		/// </summary>
		...
		public override object ReadJson(
            ...
            return new Rect(obj.Value<float>("x"), obj.Value<float>("y"), obj.Value<float>("width"), obj.Value<float>("height"));
        }

		/// <summary>
		/// Write <c>x</c>, <c>y</c>, <c>width</c> and <c>height</c>.
		/// </summary>
		...
		public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer){
			...
			var _value = (Rect)value;
			var _object = new JObject();

			_object["x"] = _value.x;
			_object["y"] = _value.y;
			_object["width"] = _value.width;
			_object["height"] = _value.height;
