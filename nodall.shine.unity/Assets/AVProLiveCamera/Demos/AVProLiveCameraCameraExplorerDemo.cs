...
namespace RenderHeads.Media.AVProLiveCamera.Demos
{
	public class AVProLiveCameraCameraExplorerDemo : MonoBehaviour
	{
		...
		private List<bool> _showSettings = new List<bool>();
		private List<bool> _showModes = new List<bool>();
		...
		private void EnumerateDevices()
		{
			...
			for (int i = 0; i < numDevices; i++)
			{
				...
				_scrollPos.Add(new Vector2(0f, 0f));
				_scrollVideoInputPos.Add(new Vector2(0f, 0f));
				_showSettings.Add(false);
				_showModes.Add(true);
			}
		}
