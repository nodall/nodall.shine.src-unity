...
namespace QRCoder
{
    public class QRCodeGenerator : IDisposable
    {
        ...
        private struct CodewordBlock
        {
            ...
            public List<string> CodeWords { get; set; }
            public List<int> CodeWordsInt { get; set; }
            public List<string> ECCWords { get; set; }
        ...
        private struct ECCInfo
        {
            ...
            public int ECCPerBlock { get; set; }
            public int BlocksInGroup1 { get; set; }
            public int CodewordsInGroup1 { get; set; }
            public int BlocksInGroup2 { get; set; }
            public int CodewordsInGroup2 { get; set; }
        }
        ...
        private struct VersionInfo
        {
            ...
            public int Version { get; set; }
            public List<VersionInfoDetails> Details { get; set; }
        }
        ...
        private struct VersionInfoDetails
        {
            ...
            public ECCLevel ErrorCorrectionLevel { get; set; }
            public Dictionary<EncodingMode, int> CapacityDict { get; set; }
        }
        ...
        private struct Antilog
        {
            ...
            public int ExponentAlpha { get; set; }
