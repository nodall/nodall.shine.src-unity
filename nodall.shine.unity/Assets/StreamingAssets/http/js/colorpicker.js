...
var UIColorPicker = (function UIColorPicker() {
	...
	ColorPicker.prototype.updateColor = function updateColor(e) {
		var x = e.pageX - this.picking_area.offsetLeft - this.picking_area.offsetParent.offsetLeft;
		var y = e.pageY - this.picking_area.offsetTop - this.picking_area.offsetParent.offsetTop;
		var picker_offset = 5;
		...
		console.log("OTOP  "+this.picking_area.offsetTop + "  OPArent"+ this.picking_area.offsetParent)
		console.log("LayerY "+ e.layerY + " PageY "+ e.pageY+ " Y "+ e.y+ " clientY "+ e.clientY)
		...
		console.log('updateColor pos '+ (x - picker_offset) + ', ' + (y - picker_offset) + 'px')
	...
	ColorPicker.prototype.updateAlphaSlider = function updateAlphaSlider(e) {
		...
		this.color.a = parseFloat((x / width).toFixed(2));
	...
	ColorPicker.prototype.updatePickerPosition = function updatePickerPosition() {
		...
		console.log('update picker position '+ (x - offset) + ', ' + (y - offset) + 'px')
	};
...
var InputSliderManager = (function InputSliderManager() {
	...
	InputSlider.prototype.setInputValue = function setInputValue() {
		this.input.value = parseFloat(this.value.toFixed(this.precision)) + this.unit;
	};
